...
<div class="page-hero">
  ...
  <h1 class="sec-title">Preserving Heritage for Generations</h1>
  <p class="page-hero-sub">The Museo de Labo is dedicated to documenting, preserving, and sharing the cultural legacy of Labo, Camarines Norte.</p>
</div>
