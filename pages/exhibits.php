...
<div class="page-hero">
  ...
  <p class="page-hero-sub"><?= $currentCat ? 'Browse artifacts under the '.htmlspecialchars($currentCat['name']).' type of artifact.' : 'Discover the complete museum collection documenting the rich legacy of Labo.' ?></p>
</div>
