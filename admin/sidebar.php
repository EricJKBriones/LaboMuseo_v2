...
<aside class="adm-sidebar" id="adminSidebar">
  ...
  <ul class="adm-menu">
    ...
    <li><a href="departments.php" class="<?= $adminPage==='departments' ?'active':'' ?>"><span class="adm-ico"><img class="icon-swap" src="../assets/Icon/categories.png" data-png="../assets/Icon/categories.png" data-gif="../assets/Icon/categories.gif" alt="" aria-hidden="true"></span><span class="adm-label">Types of Artifacts</span></a></li>
